...
public:
    ...
    bool VisitStmt(Stmt *s) {
        ...
        else if (isa<OMPTaskDirective>(s)) {
            TheRewriter.InsertText(s->getLocEnd(), " // the task part", true, true);
            s->dump();
        }
...
/*
    ...
    auto cInvoc = createInvocationFromCommandLine(args);
    TheCompInst.setInvocation(move(cInvoc));
*/
